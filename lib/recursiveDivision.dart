...
class RecursiveDivision{
  ...
  Future recurseOnBox(int r1 , int r2 , int c1,int c2) async{
    //base condition....
  ...
  await recurseOnBox(r1 , midRow - 1 , c1 , midCol-1);
  await recurseOnBox(midRow+1 ,r2, c1 , midCol-1);
  await recurseOnBox(r1 , midRow - 1 , midCol+1 , c2);
  await recurseOnBox(midRow + 1,r2 , midCol+1,c2);
  }
}